...
const addProduct = (e) => {
    ...
    axios
      .post('https://figma-backend-x6hw.onrender.com/addHotel', { nom, adresse, email, telephone, prix, montant, imageURL })
      .then(() => {
        setNom("");
        setAdresse("");
        setEmail("");
    ...
    useEffect(() => {
        axios.get('https://figma-backend-x6hw.onrender.com/getHotels')
            .then(response => {
